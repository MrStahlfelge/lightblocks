...
public class MyIosApplication implements Application {

    public static abstract class Delegate extends UIApplicationDelegateAdapter {
        private MyIosApplication app;

        protected abstract MyIosApplication createApplication ();
    ...
    MyIosAppConfig config;
    MyIosGraphics graphics;
    IOSAudio audio;
    IOSFiles files;
    MyIosInput input;
    MyIosNet net;
    ...
    public MyIosApplication (ApplicationListener listener, MyIosAppConfig config) {
    ...
    protected MyIosGraphics createGraphics(float scale) {
        return new MyIosGraphics(scale, this, config, input, config.useGL30);
    }

    protected MyIosInput createInput() {
        return new MyIosInput(this);
    }
