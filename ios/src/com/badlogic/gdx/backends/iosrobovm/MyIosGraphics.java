...
public class MyIosGraphics extends NSObject implements Graphics, GLKViewDelegate, GLKViewControllerDelegate {

    private static final String tag = "IOSGraphics";

    static class IOSUIViewController extends GLKViewController {
        final MyIosApplication app;
        final MyIosGraphics graphics;
        boolean created = false;

        IOSUIViewController (MyIosApplication app, MyIosGraphics graphics) {
            this.app = app;
    ...
    public MyIosGraphics (float scale, MyIosApplication app, IOSApplicationConfiguration config, MyIosInput input, boolean useGLES30) {
        this.config = config;
        ...
        view = new GLKView(new CGRect(0, 0, bounds.getWidth(), bounds.getHeight()), context) {
            ...
            public void touchesBegan (@Pointer long touches, UIEvent event) {
                MyIosGraphics.this.input.onTouch(touches);
            }
            ...
            public void draw (CGRect rect) {
                MyIosGraphics.this.draw(this, rect);
            }
        ...
        MyIosDevice device = MyIosDevice.getDevice(machineString);
